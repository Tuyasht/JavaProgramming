...
public class WarmupTasks {
    public static void main(String[] args) {
        ...
        numbers.addAll(Arrays.asList(1,2,3,4,5,6,7,8)); // swaping 1st and last elements
...
/*
 1. Write a program that can swap the first and last elements of the ArrayList
